...
def que2():
    ...
    print(
        f"string format = {date_str1} & datetime format = {datetime.strptime(date_str1,'%Y-%m-%d')}"
    )

    print(
        f"string format = {date_str2} & datetime format = {datetime.strptime(date_str2,'%d %b %Y')}"
    )

    print(
        f"string format = {date_str3} & datetime format = {datetime.strptime(date_str3,'%Y-%m-%d %H:%M:%S')}"
    )
